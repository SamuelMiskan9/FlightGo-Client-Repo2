...
function Payment() {
    ...
    <div className='paymentpage'>
        <div className="Pay container">
                ...
                <div className="box-left">
                    ...
                    <div className='grid grid-cols-2'>
                        <div>
                            ...
                            <div className='text text-xs'>SRG<i class="fa fa-arrow-right" aria-hidden="true"></i>SBY</div>
                        </div>
                        <div>
            ...
            <div class="col-md-5 col-12 ps-md-5 p-0 pt-4">
                <div class="box-left">
                    <div class="">
                        ...
                        <div class="form">
                            ...
                            <div className='pt-4'>
                                <div class="btn d-block h8 text-white" style={{ backgroundColor: "#F97316" }}>Bayar
                                </div>
                            </div>
                        </div>
                    </div>
